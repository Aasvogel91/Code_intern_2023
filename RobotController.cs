...
public class RobotController : MonoBehaviour
{
    ...
    public struct Joint
    {
        public string inputAxis; // input axis used to control this joint.
        public GameObject robotPart; //Robot part associated with this joint.
    }
    public Joint[] joints;
    ...
    public float[] GetCurrentJointRotations()
    {
        ...
        return list; // get the current rotations of all the robot's joints. 
    }
